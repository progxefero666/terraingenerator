    ...
    return (
        <div className="space-y-4 pt-2">
            ...
            <div className="space-y-2">
                ...
                <Slider id="intensity" value={[gradient.intensity]} 
                        onValueChange={handleSliderChange('intensity')} max={1} step={0.01} />
            </div>
            ...
            <div className="space-y-2">
                ...
                <Slider id="radius" value={[gradient.radius]} 
                        onValueChange={handleSliderChange('radius')} max={0.5} step={0.005} />
            </div>
            ...
            <div className="space-y-2">
                ...
                <Slider id="rotation" value={[gradient.rotation]} 
                        onValueChange={handleSliderChange('rotation')} min={0} max={360} step={1} />
            </div>
            ...
            <div className="space-y-2">
                ...
                <Slider id="scaleX" value={[gradient.scaleX]} 
                        onValueChange={handleSliderChange('scaleX')} min={0.2} max={5} step={0.05} />
            </div>
            ...
            <div className="space-y-2">
                ...
                <Slider id="scaleY" value={[gradient.scaleY]} 
                        onValueChange={handleSliderChange('scaleY')} min={0.2} max={5} step={0.05} />
            </div>
